  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@800&display=swap" rel="stylesheet">
    ...
    <div id="box">
      <input
              ...
              v-model="searchWord"
              type="text"
              style=" border: 5px solid black; background-repeat: no-repeat; background-position: 88% 50%, 98% 50%;"
              title="검색"
      />
...
<!--      <button id="google_search" value="Google 검색">jjj</button>-->
    </div>
...
<!--      <img-->
<!--              id="google"-->
<!--              src="https://post-phinf.pstatic.net/MjAxOTA2MDNfMTQ3/MDAxNTU5NTU1MzU3ODQx.c-DV9AFSeu5IZTlt9g16PlD8WUUKsEDll86nHJ3K3kIg.Cx2jSOBBFfFGAWxrbv2oWqDy6CgbAh9Z3ajhKWrPqhEg.JPEG/gfgfggf.jpg?type=w1200"-->
<!--              title="Google"-->
<!--      />-->
<!--    </div>-->
<!--    <div>-->
